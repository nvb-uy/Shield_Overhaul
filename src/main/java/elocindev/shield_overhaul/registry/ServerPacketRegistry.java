...
import elocindev.shield_overhaul.networking.SendAnimationC2SPacket;
...
public class ServerPacketRegistry {
    ...
    public static final Identifier SEND_ANIMATION_PACKET = new Identifier(ShieldOverhaul.MODID, "send_animation_packet");
    ...
    public static void registerC2SPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(SEND_ANIMATION_PACKET, SendAnimationC2SPacket::receive);
    }
}
